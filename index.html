...
<body>
	<h1>ITMD-361: Fundamentals of Web Development</h1>
	<h2>Fall 2023</h2>
	<p>Darnell Rhynes and drhynes@hawk.iit.edu</p>
	<h3>Professor:</h3>
	<p>Daniel Krieglstein</p>
	<h4>Lecture Days, Time and Place:</h4>
	<p>Tuesdays, 6:25pm to 9:05pm</p>
	<h5>Course Catalog Description:</h>
	...
	<ul>
		<li>Recognize HTML, CSS and JavaScript mark-up and code.</li>
